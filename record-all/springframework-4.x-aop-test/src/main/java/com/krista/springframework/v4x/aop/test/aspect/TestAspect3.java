...
public class TestAspect3 {
     ...
     * logger
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(TestAspect3.class);

    /**
     * 定义切点
     */
    @Pointcut("@annotation(com.krista.springframework.v4x.aop.test.annotation.Test2)")
